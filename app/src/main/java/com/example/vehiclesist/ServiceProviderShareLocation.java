...
public class ServiceProviderShareLocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_provider_share_location);
        ...
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("ServiceProvider");
        ...
        try {
            ...
            if (checkPermissions()) {
                ...
                if (isLocationEnabled()) {
                    ...
                    Toast.makeText(ServiceProviderShareLocation.this, "Sometimes it may take time , restart app to share again if it does not works", Toast.LENGTH_SHORT).show();
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            ...
                            if (location == null) {
                                ...
                                try {
                                    ...
                                    Geocoder geocoder = new Geocoder(ServiceProviderShareLocation.this, Locale.getDefault());
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                                ...
                                                if ((firebaseAuth.getCurrentUser().getPhoneNumber().equals(ds.child("Number").getValue().toString()))) {
                                                    ...
                                                    Toast.makeText(ServiceProviderShareLocation.this, "Your current location is shared", Toast.LENGTH_SHORT).show();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                    ...
                                    if ((firebaseAuth.getCurrentUser().getPhoneNumber().equals(ds.child("Number").getValue().toString()))) {
                                        ...
                                        Toast.makeText(ServiceProviderShareLocation.this, "Your Location is shared", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
